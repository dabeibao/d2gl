...
class MotionPrediction {
	bool m_active = false;
	// With `_STATS` the unit/missile/weather draw detours stay installed even
	// when motion prediction is off, so stats can count units regardless.
	bool m_stubs_installed = false;
